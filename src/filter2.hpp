...
struct FILTER_ITEM_TRACK {
	FILTER_ITEM_TRACK(LPCWSTR _name, double _value, double _s, double _e, double _step = 1.0, LPCWSTR _zero_display = nullptr, double _slider_ratio = 1.0)
		: name(_name), value(_value), s(_s), e(_e), step(_step), zero_display(_zero_display), slider_ratio(_slider_ratio) {}
...
struct FILTER_ITEM_TRACK_GROUP {
	FILTER_ITEM_TRACK_GROUP(LPCWSTR _name, FILTER_ITEM_TRACK** _tracks) : name(_name), tracks(_tracks) {}
...
struct FILTER_ITEM_CHECK {
	FILTER_ITEM_CHECK(LPCWSTR _name, bool _value) : name(_name), value(_value) {}
...
struct FILTER_ITEM_CHECK_SECTION {
	FILTER_ITEM_CHECK_SECTION(LPCWSTR _name, bool _value, bool _multi_section = true) : name(_name), value(_value), multi_section(_multi_section) {}
...
struct FILTER_ITEM_COLOR {
	...
	FILTER_ITEM_COLOR(LPCWSTR _name, int _code) : name(_name) { value.code = _code; }
...
struct FILTER_ITEM_SELECT {
	...
	FILTER_ITEM_SELECT(LPCWSTR _name, int _value, ITEM* _list) : name(_name), value(_value), list(_list) {}
...
struct FILTER_ITEM_FILE {
	FILTER_ITEM_FILE(LPCWSTR _name, LPCWSTR _value, LPCWSTR _filefilter) : name(_name), value(_value), filefilter(_filefilter) {}
...
struct FILTER_ITEM_DATA {
	FILTER_ITEM_DATA(LPCWSTR _name) : name(_name), size(sizeof(T)), value(&default_value) {}
...
struct FILTER_ITEM_DATA<void> {
	FILTER_ITEM_DATA(LPCWSTR _name) : name(_name) {}
	LPCWSTR type = L"data";		// 設定の種別
	LPCWSTR name;				// 設定名
...
struct FILTER_ITEM_GROUP {
	FILTER_ITEM_GROUP(LPCWSTR _name, bool _default_visible = true) : name(_name), default_visible(_default_visible) {}
...
struct FILTER_ITEM_BUTTON {
	FILTER_ITEM_BUTTON(LPCWSTR _name, void (*_callback)(EDIT_SECTION* edit)) : name(_name), callback(_callback) {}
...
struct FILTER_ITEM_STRING {
	FILTER_ITEM_STRING(LPCWSTR _name, LPCWSTR _value) : name(_name), value(_value) {}
...
struct FILTER_ITEM_TEXT {
	FILTER_ITEM_TEXT(LPCWSTR _name, LPCWSTR _value) : name(_name), value(_value) {}
...
struct FILTER_ITEM_FOLDER {
	FILTER_ITEM_FOLDER(LPCWSTR _name, LPCWSTR _value) : name(_name), value(_value) {}
...
struct FILTER_ITEM_SEPARATOR {
	FILTER_ITEM_SEPARATOR(LPCWSTR _name) : name(_name) {}
